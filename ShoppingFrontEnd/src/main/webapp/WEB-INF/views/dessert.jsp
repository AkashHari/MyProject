		...
		<div class="container">
			<div class="col-md-4 products-left">
				...
				<div class="categories animated wow slideInUp" data-wow-delay=".5s">
					<h3>Categories</h3>
					<ul class="cate">
						<li><a href="dessert">Best selling</a> <span>(15)</span></li>
						<li><a href="dessert">Desset</a> <span>(16)</span></li>
						<ul>
							<li><a href="dessert">Chocolate dessert</a> <span>(2)</span></li>
							<li><a href="dessert">Delicious</a> <span>(5)</span></li>
							<li><a href="dessert">Ice cream</a> <span>(1)</span></li>
							<li><a href="dessert">Yummy dessert</a> <span>(20)</span></li>

						</ul>
						<li><a href="dessert">Dessert Roll</a> <span>(15)</span></li>
						<li><a href="dessert">Sauces</a> <span>(15)</span></li>
						<ul>
							<li><a href="dessert">Apple</a> <span>(2)</span></li>
							<li><a href="dessert">Chilli</a> <span>(5)</span></li>
							<li><a href="dessert">Tomato</a> <span>(1)</span></li>
							<li><a href="dessert">Salsa</a> <span>(8s)</span></li>
							<li><a href="dessert">Spread</a> <span>(4)</span></li>
						</ul>
						<li><a href="dessert">Pie</a> <span>(15)</span></li>
					</ul>
				</div>
					...
					<div class="new-products-grids">
						<div class="new-products-grid">
							<div class="new-products-grid-left">
								<a href="single"><img src="resource/img/dessert/43.jpg"
									alt=" " class="img-responsive" /></a>
							</div>
							<div class="new-products-grid-right">
								<h4>
									<a href="single">Ice cream Chocolate</a>
								</h4>
								<div class="rating">
								...
								<div
									...
									<p>
										<span class="item_price">&#8377 40</span><a class="item_add"
											href="#">add to cart </a>
									</p>
								</div>
							</div>
						...
						<div class="new-products-grid">
							<div class="new-products-grid-left">
								<a href="single"><img src="resource/img/dessert/44.jpg"
									alt=" " class="img-responsive" /></a>
							</div>
							<div class="new-products-grid-right">
								<h4>
									<a href="single">Cake Butter lush Dessert</a>
								</h4>
								<div class="rating">
									<div class="rating-left">
										<img src="resource/img/2.png" alt=" " class="img-responsive">
								...
								<div
									class="simpleCart_shelfItem new-products-grid-right-add-cart">
									<p>
										<span class="item_price">&#8377 250</span><a class="item_add"
											href="#">add to cart </a>
									</p>
								</div>
							</div>
						...
						<div class="new-products-grid">
							<div class="new-products-grid-left">
								<a href="single"><img src="resource/img/dessert/45.jpg"
									alt=" " class="img-responsive" /></a>
							</div>
							<div class="new-products-grid-right">
								<h4>
									<a href="single">Apple Pie Roll</a>
								</h4>
								<div class="rating">
									<div class="rating-left">
										<img src="resource/img/2.png" alt=" " class="img-responsive">
								...
								<div
									class="simpleCart_shelfItem new-products-grid-right-add-cart">
									<p>
										<span class="item_price">&#8377 20</span><a class="item_add"
											href="#">add to cart </a>
									</p>
								</div>
							</div>
				...
				<div class="men-position animated wow slideInUp"
					data-wow-delay=".5s">
					<a href="single"><img
						src="resource/img/dessert/doffer.jpg" alt=" "
						class="img-responsive" /></a>
					<div class="men-position-pos">
						<h4>Special Offer</h4>
						<h5>
							<span>20%</span> Flat Discount
						</h5>
					</div>
				</div>
			</div>
			<div class="col-md-8 products-right">
				<div class="products-right-grid">
					<div
						...
						data-wow-delay=".5s">
						<img src="resource/img/dessert/hp.jpg" alt=" "
				...
				<div class="products-right-grids-bottom">
					<div class="col-md-4 products-right-grids-bottom-grid">
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/dessert/34.jpg"
									alt=" " class="img-responsive"></a>
								<div
							...
							<h4>
								<a href="single">Tiramissu Dessert</a>
							</h4>
							<p>Choco with ice cream</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p>
									<i>&#8377 205</i> <span class="item_price">&#8377 150</span><a
						...
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/dessert/35.jpg"
									alt=" " class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
							...
							<h4>
								<a href="single">American Dessert</a>
							</h4>
							<p>White cake with Strawberry</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p>
									<i>&#8377 325</i> <span class="item_price">&#8377 250</span><a
										class="item_add" href="#">add to cart </a>
								</p>
							</div>
						</div>
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/dessert/36.png"
									alt=" " class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
							...
							<h4>
								<a href="single">Dessert sundae</a>
							</h4>
							<p>cream with caramel</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p>
									<i>&#8377 585</i> <span class="item_price">&#8377 489</span><a
										class="item_add" href="#">add to cart </a>
								</p>
							</div>
						</div>
					...
					<div class="col-md-4 products-right-grids-bottom-grid">
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/dessert/37.jpg"
									alt=" " class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
							...
							<h4>
								<a href="single">Delicious Dessert</a>
							</h4>
							<p>Chocolate with Cream</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p>
									<i>&#8377 280</i> <span class="item_price">&#8377 250</span><a
										class="item_add" href="#">add to cart </a>
								</p>
							</div>
						</div>
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/dessert/38.jpg"
									alt=" " class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
							...
							<h4>
								<a href="single">Dessert Raspberry</a>
							</h4>
							<p>Special Occation</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p>
									<i>&#8377 500</i> <span class="item_price">&#8377 480</span><a
										class="item_add" href="#">add to cart </a>
								</p>
							</div>
						</div>
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/dessert/39.jpg"
									alt=" " class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
							...
							<h4>
								<a href="single">Pumkin Pie</a>
							</h4>
							<p>Pumkin Whoopie Pie</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p>
									<i>&#8377 585</i> <span class="item_price">&#8377 489</span><a
										class="item_add" href="#">add to cart </a>
					...
					<div class="col-md-4 products-right-grids-bottom-grid">
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/dessert/40.jpg"
									alt=" " class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
							...
							<p>Dark chocolate with ice cream</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p>
									<i>&#8377 305</i> <span class="item_price">&#8377 280</span><a
										class="item_add" href="#">add to cart </a>
								</p>
							</div>
						</div>
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/dessert/41.jpg"
									alt=" " class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
							...
							<h4>
								<a href="single">Dessert Mix</a>
							</h4>
							<p>Three layer</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p>
									<i>&#8377 389</i> <span class="item_price">&#8377 299</span><a
										class="item_add" href="#">add to cart </a>
								</p>
							</div>
						</div>
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/dessert/42.jpg"
									alt=" " class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
							...
							<h4>
								<a href="single">Cheesecake Dessert</a>
							</h4>
							<p>Fresh Dessert</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p>
		...
		<div class="container">
			<div class="footer-grids">
				<div class="col-md-3 footer-grid animated wow slideInLeft" data-wow-delay=".5s">
					<h3>About Us</h3>
					<p>One cannot think well, love well, sleep well, if one has not dined well<span>You don't need a sliver fork 
						to eat good food</span></p>
				</div>
				<div class="col-md-3 footer-grid animated wow slideInLeft" data-wow-delay=".6s">
					<h3>Contact Info</h3>
					<ul>
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>1234k Avenue, 4th block, <span>Chennai.</span></li>
