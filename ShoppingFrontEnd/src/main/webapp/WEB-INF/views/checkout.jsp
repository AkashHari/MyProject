			...
			<h3 class="animated wow slideInLeft" data-wow-delay=".5s">Your shopping cart contains: <span>3 Products</span></h3>
				...
				<table class="timetable_sub">
					...
					<tr class="rem1">
						...
						<td class="invert-image"><a href="single"><img src="resource/img/s2.png" alt=" " class="img-responsive" /></a></td>
						<td class="invert">
							 <div class="quantity"> 
						...
						<td class="invert">Chunky monkey banana Popsicles</td>
						<td class="invert">&#8377 5.00</td>
						<td class="invert">&#8377 20.00</td>
						<td class="invert">
							<div class="rem">
				...
				<div class="checkout-left-basket animated wow slideInLeft" data-wow-delay=".5s">
					...
					<ul>
						<li>Product1 <i>-</i> <span>&#8377 20.00 </span></li>
                                                <li>Total Service Charges <i>-</i> <span>&#8377 5.00</span></li>
						<li>Total <i>-</i> <span>&#8377 25.00</span></li>
					</ul>
				</div>
