...
<!-- register -->
	<div class="register">
		<div class="container">
			...
			<p class="est animated wow zoomIn" data-wow-delay=".5s">New User please Register.! 
				To Enjoy Food Castel Shopping</p>
				...
				<form action="register" method="post" class="animated wow slideInUp" data-wow-delay=".5s">
					<input type="email" placeholder="Email Address" id="name" name="name" required=" " >
					<input type="password" placeholder="Password" id="password" name="password"required=" " >
					<input type="password" placeholder="Password Confirmation" id="password confirmation" name="password confirmation" required=" " >
					Gender: 
  					<ul><input type="radio" name="gender" value="male"> Male<br>
  					<input type="radio" name="gender" value="female"> Female<br>
  					<input type="radio" name="gender" value="other"> Other<br></ul>
                    D.O.B: <input type="date" name="bday">
