		...
		<div class="container">
			<div class="col-md-4 products-left">
				...
				<div class="categories animated wow slideInUp" data-wow-delay=".5s">
					<h3>Categories</h3>
					<ul class="cate">
						<li><a href="patis">Best selling</a> <span>(15)</span></li>
						<li><a href="patis">Cookies</a> <span>(16)</span></li>
						<ul>
							<li><a href="patis">Apple</a> <span>(2)</span></li>
							<li><a href="patis">Wheat</a> <span>(5)</span></li>

							<li><a href="patis">Donut</a> <span>(20)</span></li>

						</ul>
						<li><a href="patis">Biscotti</a> <span>(15)</span></li>
						<li><a href="patis">Browine</a> <span>(15)</span></li>
						<ul>
							<li><a href="patis">Dark</a> <span>(2)</span></li>
							<li><a href="patis">Cup Cake</a> <span>(5)</span></li>
							<li><a href="patis">Bar</a> <span>(1)</span></li>
							<li><a href="patis">Cookie</a> <span>(8)</span></li>
					...
					<div class="new-products-grids">
						<div class="new-products-grid">
							<div class="new-products-grid-left">
								<a href="single"><img src="resource/img/patis/79.jpg"
									alt=" " class="img-responsive" /></a>
							</div>
							<div class="new-products-grid-right">
								<h4>
									<a href="single">Biscotti</a>
								</h4>
								<div class="rating">
						...
						<div class="new-products-grid">
							<div class="new-products-grid-left">
								<a href="single"><img src="resource/img/patis/80.jpg"
									alt=" " class="img-responsive" /></a>
							</div>
							<div class="new-products-grid-right">
								<h4>
									<a href="single">Cheese Browine</a>
								</h4>
								<div class="rating">
									<div class="rating-left">
										<img src="resource/img/2.png" alt=" " class="img-responsive">
						...
						<div class="new-products-grid">
							<div class="new-products-grid-left">
								<a href="single"><img src="resource/img/patis/81.jpg"
									alt=" " class="img-responsive" /></a>
							</div>
							<div class="new-products-grid-right">
								<h4>
									<a href="single">Nuts cake</a>
								</h4>
								<div class="rating">
									<div class="rating-left">
										<img src="resource/img/2.png" alt=" " class="img-responsive">
				...
				<div class="men-position animated wow slideInUp"
					data-wow-delay=".5s">
					<a href="single"><img src="resource/img/patis/poffer.jpg"
						alt=" " class="img-responsive" /></a>
			...
			<div class="col-md-8 products-right">
				<div class="products-right-grid">
					<div
						...
						data-wow-delay=".5s">
						<img src="resource/img/patis/hp1 (2).jpg" alt=" "
							class="img-responsive" />
						<div class="products-right-grids-position1">
							<h4>2016 OFFER</h4>
							<p>White Cake with chocolate</p>
						</div>
					</div>
				</div>
				<div class="products-right-grids-bottom">
					<div class="col-md-4 products-right-grids-bottom-grid">
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/patis/70.jpg" alt=" " class="img-responsive"></a>
								<div
							...
							<h4>
								<a href="single">Peanut Butter cake</a>
							</h4>
							<p>cup cake</p>
						...
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/patis/71.jpg" alt=" " class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
								</div>
						...
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/patis/72.jpg" alt=" " class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
								</div>
							...
							<h4>
								<a href="single">Italian Ricotta</a>
							</h4>
							<p>Cookie</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p>
					...
					<div class="col-md-4 products-right-grids-bottom-grid">
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/patis/73.jpg" alt=" " class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
								</div>
						...
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/patis/74.jpg" alt=" " class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
								</div>
						...
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/patis/75.jpg" alt=" " class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
								</div>
					...
					<div class="col-md-4 products-right-grids-bottom-grid">
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/patis/76.jpg" alt=" " class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
								</div>
						...
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/patis/77.jpg" alt=" " class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
								</div>
							...
							<h4>
								<a href="single">Deep fry cookie</a>
							</h4>
							<p>Ball</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p>
						...
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/patis/78.jpg" alt=" " class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
								</div>
							...
							<h4>
								<a href="single">Lemon Pistachio</a>
							</h4>
							<p>Biscotti</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p>
