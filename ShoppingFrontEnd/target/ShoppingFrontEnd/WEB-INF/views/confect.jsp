		...
		<div class="container">
			<div class="col-md-4 products-left">
				...
				<div class="categories animated wow slideInUp" data-wow-delay=".5s">
					<h3>Categories</h3>
					<ul class="cate">
						<li><a href="confect">Best selling</a> <span>(15)</span></li>
						<li><a href="confect">Candies</a> <span>(16)</span></li>
						<ul>
							<li><a href="confect">Dipped</a> <span>(2)</span></li>
							<li><a href="confect">Mint Chocolate</a> <span>(5)</span></li>

							<li><a href="confect">Lolipop</a> <span>(20)</span></li>

						</ul>
						<li><a href="confect">Marshmallow</a> <span>(15)</span></li>
						<li><a href="confect">Gum</a> <span>(15)</span></li>
						<ul>
							<li><a href="confect">Jelly</a> <span>(2)</span></li>
							<li><a href="confect">Cup Cake</a> <span>(5)</span></li>
							<li><a href="confect">Bar</a> <span>(1)</span></li>
							<li><a href="confect">Cookie</a> <span>(8)</span></li>

						</ul>
						<li><a href="confect">Mint</a> <span>(15)</span></li>
					</ul>
				</div>
					...
					<div class="new-products-grids">
						<div class="new-products-grid">
							<div class="new-products-grid-left">
								<a href="single"><img src="resource/img/confect/67.jpg"
									alt=" " class="img-responsive" /></a>
							</div>
							<div class="new-products-grid-right">
								<h4>
									<a href="single">Mint</a>
								</h4>
								<div class="rating">
						...
						<div class="new-products-grid">
							<div class="new-products-grid-left">
								<a href="single"><img src="resource/img/confect/68.jpg"
									alt=" " class="img-responsive" /></a>
							</div>
							<div class="new-products-grid-right">
								<h4>
									<a href="single">Chocolate chip mint</a>
								</h4>
								<div class="rating">
									<div class="rating-left">
										<img src="resource/img/2.png" alt=" " class="img-responsive">
						...
						<div class="new-products-grid">
							<div class="new-products-grid-left">
								<a href="single"><img src="resource/img/confect/69.jpg"
									alt=" " class="img-responsive" /></a>
							</div>
							<div class="new-products-grid-right">
								<h4>
									<a href="single">Chocolate Dipped peeps</a>
								</h4>
								<div class="rating">
									<div class="rating-left">
										<img src="resource/img/2.png" alt=" " class="img-responsive">
				...
				<div class="men-position animated wow slideInUp"
					data-wow-delay=".5s">
					<a href="single"><img
						src="resource/img/confect/coffer.jpg" alt=" "
			...
			<div class="col-md-8 products-right">
				<div class="products-right-grid">
					<div
						...
						data-wow-delay=".5s">
						<img src="resource/img/confect/homepage.jpg" alt=" "
				...
				<div class="products-right-grids-bottom">
					<div class="col-md-4 products-right-grids-bottom-grid">
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/confect/58.jpg"
									alt=" " class="img-responsive"></a>
								<div
							...
							<h4>
								<a href="single">Mint Choco bar</a>
							</h4>
							<p>mint bar</p>
						...
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/confect/59.jpg"
									alt=" " class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
						...
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/confect/60.jpg"
									alt=" " class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
							...
							<h4>
								<a href="single">Strawberry Jelly</a>
							</h4>
							<p>Fresh Jelly</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p>
					...
					<div class="col-md-4 products-right-grids-bottom-grid">
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/confect/61.jpg"
									alt=" " class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
						...
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/confect/62.jpg"
									alt=" " class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
						...
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/confect/63.jpg"
									alt=" " class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
					...
					<div class="col-md-4 products-right-grids-bottom-grid">
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/confect/64.jpg"
									alt=" " class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
							...
							<h4>
								<a href="single">Mashmellow Pop</a>
							</h4>
							<p>Toppings</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p>
						...
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/confect/65.jpg"
									alt=" " class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
							...
							<h4>
								<a href="single">Mint Chocolate</a>
							</h4>
							<p>Cup cake</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p>
						...
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/confect/66.jpg"
									alt=" " class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
							...
							<h4>
								<a href="single">Mashmellow</a>
							</h4>
							<p>Chocolate with cookie</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p>
									<i>&#8377 585</i> <span class="item_price">&#8377 489</span><a
										class="item_add" href="#">add to cart </a>
	...
	<div class="footer">
		<div class="container">
			...
			<div class="footer-logo animated wow slideInUp" data-wow-delay=".5s">
				<h2><a href="index">Food Basket <span>Enjoy Eating</span></a></h2>
			</div>
