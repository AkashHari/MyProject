		...
		<div class="container">
			<div class="col-md-4 products-left">
				...
				<div class="categories animated wow slideInUp" data-wow-delay=".5s">
					<h3>Categories</h3>
					<ul class="cate">
						<li><a href="icecream">Best selling</a> <span>(15)</span></li>
						<li><a href="icecream">Ice cream</a> <span>(16)</span></li>
						<ul>
							<li><a href="icecream">Sundae</a> <span>(2)</span></li>
							<li><a href="icecream">Delicious</a> <span>(5)</span></li>
							<li><a href="icecream">Ice cream</a> <span>(1)</span></li>
							<li><a href="icecream">Ice cream dessert</a> <span>(20)</span></li>

						</ul>
						<li><a href="icecream">Chocolate Ice cream</a> <span>(15)</span></li>
						<li><a href="icecream">Bar</a> <span>(15)</span></li>
						<ul>
							<li><a href="icecream">Biscotti</a> <span>(2)</span></li>
							<li><a href="icecream">Chocolate </a> <span>(5)</span></li>
							<li><a href="icecream">Nuts</a> <span>(1)</span></li>
							<li><a href="icecream">Fruit Bar</a> <span>(8)</span></li>
							<li><a href="icecream">Fruit Sicles</a> <span>(4)</span></li>
						</ul>
						<li><a href="icecream">Popsicles</a> <span>(15)</span></li>
					</ul>
				</div>
					...
					<div class="new-products-grids">
						<div class="new-products-grid">
							<div class="new-products-grid-left">
								<a href="single"><img
									src="resource/img/icecream/55.jpg" alt=" "
									class="img-responsive" /></a>
							</div>
							<div class="new-products-grid-right">
								<h4>
									<a href="single">Mixed Whoopie Pie</a>
								</h4>
								<div class="rating">
						...
						<div class="new-products-grid">
							<div class="new-products-grid-left">
								<a href="single"><img
									src="resource/img/icecream/56.jpg" alt=" "
									class="img-responsive" /></a>
							</div>
							<div class="new-products-grid-right">
								<h4>
									<a href="single">Cone with Toppings</a>
								</h4>
								<div class="rating">
									<div class="rating-left">
										<img src="resource/img/2.png" alt=" " class="img-responsive">
						...
						<div class="new-products-grid">
							<div class="new-products-grid-left">
								<a href="single"><img
									src="resource/img/icecream/57.jpg" alt=" "
									class="img-responsive" /></a>
							</div>
							<div class="new-products-grid-right">
								<h4>
									<a href="single">Nutty Ice Cream</a>
								</h4>
								<div class="rating">
									<div class="rating-left">
										<img src="resource/img/2.png" alt=" " class="img-responsive">
				...
				<div class="men-position animated wow slideInUp"
					data-wow-delay=".5s">
					<a href="single"><img
						src="resource/img/icecream/ioffer.jpg" alt=" "
						class="img-responsive" /></a>
					<div class="men-position-pos">
						<h4>Mint Ice Cream Sandwiches</h4>
						<h5>
			...
			<div class="col-md-8 products-right">
				<div class="products-right-grid">
					<div
						...
						data-wow-delay=".5s">
						<img src="resource/img/icecream/hp.jpg" alt=" "
							class="img-responsive" />
						<div class="products-right-grids-position1">
							<h4>2016 OFFER</h4>
							<p>Dark Cone Walnut</p>
						</div>
					</div>
				</div>
				<div class="products-right-grids-bottom">
					<div class="col-md-4 products-right-grids-bottom-grid">
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/icecream/46.jpg" alt=" "
									class="img-responsive"></a>
								<div
							...
							<h4>
								<a href="single">Chocolate Ice cream Cake</a>
							</h4>
							<p>Icecream cake</p>
						...
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/icecream/47.jpg" alt=" "
									class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
							...
							<h4>
								<a href="single">Pepper Mint Ice Cream</a>
							</h4>
							<p>Mint ice cream</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p>
						...
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/icecream/48.jpg" alt=" "
									class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
							...
							<h4>
								<a href="single">Honeyd Peache Ice Cream</a>
							</h4>
							<p>Honey Peach</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p>
					...
					<div class="col-md-4 products-right-grids-bottom-grid">
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/icecream/49.jpg" alt=" "
									class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
							...
							<h4>
								<a href="single">Cookie Ice Cream</a>
							</h4>
							<p>Cookie icecream</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p>
						...
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/icecream/50.jpg" alt=" "
									class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
							...
							<h4>
								<a href="single">Raspberry Coconut</a>
							</h4>
							<p>Raspberry icecream</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p>
						...
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/icecream/51.jpg" alt=" "
									class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
							...
							<h4>
								<a href="single">Ice Cream Choco</a>
							</h4>
							<p>choco sprinkel</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p>
					...
					<div class="col-md-4 products-right-grids-bottom-grid">
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/icecream/52.jpg" alt=" "
									class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
							...
							<h4>
								<a href="single">Vanilla Ice cream </a>
							</h4>
							<p>Vanilla</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p>
						...
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/icecream/53.jpg" alt=" "
									class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
							...
							<h4>
								<a href="single">Gulab Jamun with Vanilla</a>
							</h4>
							<p>Awesome Taste</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p>
						...
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src=resource/img/icecream/54.jpg " alt=" "
									class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
