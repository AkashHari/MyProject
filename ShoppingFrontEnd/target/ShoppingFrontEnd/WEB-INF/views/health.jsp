		...
		<div class="container">
			<div class="col-md-4 products-left">
				...
				<div class="categories animated wow slideInUp" data-wow-delay=".5s">
					<h3>Categories</h3>
					<ul class="cate">
						<li><a href="health">Best selling</a> <span>(15)</span></li>
						<li><a href="health">Weight Management</a> <span>(16)</span></li>
						<ul>
							<li><a href="health">Sea Food</a> <span>(2)</span></li>
							<li><a href="health">Soups & Dressings</a> <span>(5)</span></li>
							<li><a href="health">Fruits</a> <span>(1)</span></li>
							<li><a href="health">Fresh Juice</a> <span>(20)</span></li>

						</ul>
						<li><a href="health">Heart-Healthy Food</a> <span>(15)</span></li>
						<li><a href="health">Diabetic-friendly Foods</a> <span>(15)</span></li>
						<ul>
							<li><a href="health">Rabbi Dates</a> <span>(2)</span></li>
							<li><a href="health">Sharifa Dates</a> <span>(5)</span></li>
							<li><a href="health">Zard Dates</a> <span>(1)</span></li>
							<li><a href="health">Panado Dates</a> <span>(8s)</span></li>
							<li><a href="health">Radage Dates</a> <span>(4)</span></li>
						</ul>
					</ul>
				</div>
					...
					<div class="new-products-grids">
						<div class="new-products-grid">
							<div class="new-products-grid-left">
								<a href="single"><img src="resource/img/health/109.png"
									alt=" " class="img-responsive" /></a>
							</div>
							<div class="new-products-grid-right">
								<h4>
									<a href="single">Horse Gram</a>
								</h4>
								<div class="rating">
						...
						<div class="new-products-grid">
							<div class="new-products-grid-left">
								<a href="single"><img src="resource/img/health/110.jpg"
									alt=" " class="img-responsive" /></a>
							</div>
							<div class="new-products-grid-right">
								<h4>
									<a href="single">Oats</a>
								</h4>
								<div class="rating">
									<div class="rating-left">
										<img src="resource/img/2.png" alt=" " class="img-responsive">
						...
						<div class="new-products-grid">
							<div class="new-products-grid-left">
								<a href="single"><img src="resource/img/health/111.jpg"
									alt=" " class="img-responsive" /></a>
							</div>
							<div class="new-products-grid-right">
								<h4>
									<a href="single">Lemmon Fresh Juice</a>
								</h4>
								<div class="rating">
									<div class="rating-left">
										<img src="resource/img/2.png" alt=" " class="img-responsive">
				...
				<div class="men-position animated wow slideInUp"
					data-wow-delay=".5s">
					<a href="single"><img src="resource/img/health/offer.jpg"
						alt=" " class="img-responsive" /></a>
			...
			<div class="col-md-8 products-right">
				<div class="products-right-grid">
					<div
						...
						data-wow-delay=".5s">
						<img src="resource/img/health/2015_homepage_berries.jpg" alt=" "
				...
				<div class="products-right-grids-bottom">
					<div class="col-md-4 products-right-grids-bottom-grid">
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/health/100.jpg" alt=" "
						...
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/health/101.jpg" alt=" "
									class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
						...
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/health/102.jpg" alt=" "
									class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
					...
					<div class="col-md-4 products-right-grids-bottom-grid">
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/health/103.jpg" alt=" "
									class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
							...
							<h4>
								<a href="single">Dried Apricots</a>
							</h4>
						...
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/health/104.jpg" alt=" "
									class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
							...
							<h4>
								<a href="single">Pomegranate Fresh Juice</a>
							</h4>
							<p>Fresh dry plums</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p>
						...
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/health/105.jpg" alt=" "
									class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
					...
					<div class="col-md-4 products-right-grids-bottom-grid">
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/health/106.jpg" alt=" "
									class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
						...
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/health/107.jpg" alt=" "
									class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
						...
						<div
							...
							<div class="new-collections-grid1-image">
								<a href="single" class="product-image"><img
									src="resource/img/health/108.jpg" alt=" "
									class="img-responsive"></a>
								<div
									class="new-collections-grid1-image-pos products-right-grids-pos">
									<a href="single">Quick View</a>
							...
							<h4>
								<a href="single">Pumkin Oatmeal Cookies</a>
							</h4>
							<p>Fresh Dates</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p>
